package dev.atharvakulkarni.easyflipview;
...
public class EasyFlipView extends FrameLayout
{
    ...
    private void loadAnimations()
    {
        if (flipType.equalsIgnoreCase("horizontal"))
        {
            ...
            {
                mSetRightOut = (AnimatorSet) AnimatorInflater.loadAnimator(this.context, animFlipHorizontalRightOutId);
                mSetLeftIn = (AnimatorSet) AnimatorInflater.loadAnimator(this.context, animFlipHorizontalRightInId);
            }
        ...
        else
        {
            ...
            else
            {
                ...
                mSetBottomIn = (AnimatorSet) AnimatorInflater.loadAnimator(this.context, animFlipVerticalInId);
            }
    ...
    public void flipTheView()
    {
        ...
        {
            if (mSetTopOut.isRunning() || mSetBottomIn.isRunning())
                return;
